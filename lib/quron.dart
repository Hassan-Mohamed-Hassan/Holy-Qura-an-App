...
import 'package:quron/logic.dart';
class quronlayout extends StatelessWidget {
  List<String>names=[
    '1- الفاتحة',
    '2- البقرة'	,'3- آل عمران',
    ...
    return SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children:names.map((e) => InkWell(
              onTap: (){
                logic l=new logic();
                l.ontabfun(e,names,context);
              },
              child: Container(
                height: 50,
                ...
                child: Card(
                  color: Colors.white,
                  child: Text(e,style: TextStyle(fontSize: 18),textAlign: TextAlign.center,),),
              ),
            )
            ).toList()
          ),
